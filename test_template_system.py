...
from inventag.reporting.branding_system import (
    BrandingThemeManager,
    create_default_branding_config,
)
from inventag.reporting.configuration_manager import (
...
def test_branding_system():
    ...
    custom_theme = branding_manager.create_custom_theme(
        "professional_blue", company_name="Test Company", primary_color="#FF6B35"
    )
