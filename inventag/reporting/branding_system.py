...
class PageLayoutConfiguration:
    ...
    margins: Dict[str, float] = field(
        default_factory=lambda: {"top": 1.0, "bottom": 1.0, "left": 1.25, "right": 1.0}
    )
...
class ConditionalFormattingTheme:
    ...
    compliant_format: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    non_compliant_format: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    partial_compliant_format: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    unknown_format: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    high_risk_format: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    medium_risk_format: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    low_risk_format: Dict[str, Any] = field(
        default_factory=lambda: {
            "background_color": "#E8F5E8",
            "text_color": "#1B5E20",
            "font_weight": "normal",
...
class BrandingThemeManager:
    ...
    def _initialize_predefined_themes(self) -> Dict[str, AdvancedBrandingConfig]:
        ...
        professional_blue = AdvancedBrandingConfig(
            ...
            fonts=FontConfiguration(primary_font="Calibri", secondary_font="Arial"),
        )
        ...
        modern_dark = AdvancedBrandingConfig(
            ...
            fonts=FontConfiguration(primary_font="Segoe UI", secondary_font="Arial"),
        )
    ...
    def create_custom_theme(
        self, base_theme: str = "professional_blue", **customizations
        ...
        custom_theme = AdvancedBrandingConfig(
            ...
            document_classification=customizations.get(
                "document_classification", base.document_classification
            ),
            logo=base.logo,
            colors=base.colors,
            fonts=base.fonts,
...
def create_default_branding_config(
    company_name: str = "Organization", theme: str = "professional_blue"
) -> AdvancedBrandingConfig:
