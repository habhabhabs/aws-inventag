    ...
    def test_bom_converter_output_format_compatibility(self, sample_inventory_data):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if result.returncode != 0:
                ...
                assert 'ModuleNotFoundError' in result.stderr or 'ImportError' in result.stderr or 'No module named' in result.stderr
            else:
    ...
    def test_tag_compliance_checker_output_format_compatibility(self, sample_inventory_data):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if result.returncode != 0:
                ...
                assert 'compliance' in result.stdout.lower() or os.path.exists(json_output + '.json')
