...
class TestTagMappingEngine:
    ...
    def test_extract_custom_attributes_case_insensitive(self):
        ...
        mapping = TagMapping(tag="test:case", name="Case Test", case_sensitive=False)
        self.engine.add_mapping(mapping)

        resource = {
            "id": "test-resource",
            "tags": {"TEST:CASE": "value"},  # Different case
        }
    ...
    def test_extract_custom_attributes_case_sensitive(self):
        ...
        mapping = TagMapping(tag="test:case", name="Case Test", case_sensitive=True)
        self.engine.add_mapping(mapping)
    ...
    def test_extract_custom_attributes_with_normalization(self):
        ...
        mapping = TagMapping(
            tag="test:normalize", name="Normalize Test", normalize_function="uppercase"
        )
        self.engine.add_mapping(mapping)

        resource = {"id": "test-resource", "tags": {"test:normalize": "test value"}}
    ...
    def test_extract_custom_attributes_with_validation(self):
        ...
        # Test valid value
        resource = {"id": "test-resource", "tags": {"test:validate": "VALID-123"}}
    ...
    def test_extract_custom_attributes_required_tags(self):
        ...
        mapping = TagMapping(tag="test:required", name="Required Test", required=True)
        self.engine.add_mapping(mapping)

        # Test missing required tag
        resource = {"id": "test-resource", "tags": {}}
    ...
    def test_apply_mappings_error_handling(self):
        ...
        resources = [
            ...
            {"id": "valid-resource", "tags": {"inventag:remarks": "valid"}},
        ]
    ...
    def test_end_to_end_workflow(self):
        ...
        try:
            ...
            resources = [
                ...
                {"id": "resource-3", "tags": {}},  # Missing required tags
            ]
