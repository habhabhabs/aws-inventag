...
class TestSecurityAnalyzer(unittest.TestCase):
    ...
    def test_extract_security_group_ids(self):
        ...
        resource3 = {"security_group_ids": ["sg-111111", "sg-222222"]}
    ...
    def test_parse_security_rule_all_traffic(self):
        ...
        rule_data = {"IpProtocol": "-1", "IpRanges": [{"CidrIp": "0.0.0.0/0"}]}
        ...
        self.assertEqual(
            rule.risk_assessment, "medium"
        )  # All ports but not high-risk specific port
