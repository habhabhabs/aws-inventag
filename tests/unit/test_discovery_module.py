...
class TestAWSResourceDiscovery:
    ...
    def test_discover_rds_instances(self, mock_session):
        ...
        rds_instances = [r for r in resources if r['service'] == 'RDS' and r['type'] == 'DBInstance']
    ...
    def test_discover_lambda_functions(self, mock_session):
        ...
        lambda_functions = [r for r in resources if r['service'] == 'Lambda' and r['type'] == 'Function']
...
class TestSecurityValidation:
    ...
    def test_read_only_operations_only(self, mock_session):
        ...
        read_only_patterns = [
            'describe_', 'list_', 'get_', 'head_'
        ]
        
        write_operations = [
            'create_', 'delete_', 'update_', 'modify_', 'put_', 'post_',
    ...
    def test_no_resource_modification(self, mock_session):
        ...
        write_methods = [
            'create_instances', 'terminate_instances', 'stop_instances',
            'start_instances', 'reboot_instances', 'modify_instance_attribute'
        ]
        
        for method in write_methods:
            setattr(mock_ec2, method, Mock(side_effect=Exception(f"Write operation {method} not allowed")))
