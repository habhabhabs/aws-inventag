...
class TestS3Handler:
    ...
    def test_enrich_non_bucket_resource(self):
        ...
        resource = {"service": "S3", "type": "Object", "id": "test-object"}
    ...
    def test_enrich_bucket_without_id(self):
        ...
        resource = {"service": "S3", "type": "Bucket"}
    ...
    def test_enrich_bucket_api_failure(self):
        ...
        resource = {"service": "S3", "type": "Bucket", "id": "test-bucket"}
...
class TestRDSHandler:
    ...
    def test_enrich_db_instance_success(self):
        ...
        resource = {"service": "RDS", "type": "DBInstance", "id": "test-db-instance"}
    ...
    def test_enrich_db_cluster_success(self):
        ...
        resource = {"service": "RDS", "type": "DBCluster", "id": "test-db-cluster"}
...
class TestEC2Handler:
    ...
    def test_enrich_ec2_instance_success(self):
        ...
        resource = {"service": "EC2", "type": "Instance", "id": "i-1234567890abcdef0"}
        ...
        mock_instance = {
            ...
            "BlockDeviceMappings": [
                {"DeviceName": "/dev/xvda", "Ebs": {"VolumeId": "vol-12345678"}}
            ],
    ...
    def test_enrich_ebs_volume_success(self):
        ...
        resource = {"service": "EC2", "type": "Volume", "id": "vol-1234567890abcdef0"}
...
class TestLambdaHandler:
    ...
    def test_enrich_lambda_function_success(self):
        ...
        resource = {"service": "LAMBDA", "type": "Function", "id": "test-function"}
        ...
        with patch.object(self.handler, "_safe_api_call") as mock_safe_call:
            ...
            def side_effect(client, operation, **kwargs):
                if operation == "get_function":
                    return {"Configuration": mock_function_config, "Code": mock_code}
...
class TestECSHandler:
    ...
    def test_enrich_ecs_cluster_success(self):
        ...
        resource = {"service": "ECS", "type": "Cluster", "id": "test-cluster"}
...
class TestEKSHandler:
    ...
    def test_enrich_eks_cluster_success(self):
        ...
        resource = {"service": "EKS", "type": "Cluster", "id": "test-cluster"}
