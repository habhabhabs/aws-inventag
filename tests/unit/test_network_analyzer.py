...
class TestNetworkAnalyzer(unittest.TestCase):
    ...
    def test_cache_subnet_info(self):
        ...
        self.analyzer.vpc_cache["vpc-12345"] = VPCAnalysis(
            vpc_id="vpc-12345", vpc_name="test-vpc", cidr_block="10.0.0.0/16"
        )
        ...
        self.assertAlmostEqual(
            subnet_analysis.utilization_percentage, expected_utilization, places=2
        )
    ...
    def test_generate_capacity_warnings(self):
        ...
        vpc_analysis = {"vpc-high": high_util_vpc, "vpc-normal": normal_vpc}
