...
- [Service Enrichment Guide](/architecture/service-enrichment) - Deep service attribute extraction
- [State Management Guide](/architecture/state-management) - Tracking changes over time
