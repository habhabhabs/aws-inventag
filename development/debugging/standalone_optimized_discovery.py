...
class OptimizedFieldMapper:
        ...
        try:
            ...
            if resource.tags:
                resource.environment = (
                    resource.tags.get("Environment") or 
                    resource.tags.get("Env") or 
                    resource.tags.get("Stage")
                )
                resource.project = (
                    resource.tags.get("Project") or 
                    resource.tags.get("ProjectName") or 
                    resource.tags.get("Application")
                )
                resource.cost_center = (
                    resource.tags.get("CostCenter") or 
                    resource.tags.get("BillingCode")
                )
    ...
    def _extract_resource_type(self, data: Dict[str, Any], operation_name: str, service_key: str) -> str:
