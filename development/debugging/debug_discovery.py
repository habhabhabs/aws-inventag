...
class DiscoveryDebugger:
    ...
    def compare_discovery_methods(self):
        ...
        intelligent_inventory.configure_discovery_mode(use_intelligent=True, standardized_output=True)
        ...
        return {
            'legacy': {'count': len(legacy_resources), 'services': legacy_services, 'resources': legacy_resources},
            'intelligent': {'count': len(intelligent_resources), 'services': intelligent_services, 'resources': intelligent_resources}
        }
    ...
    def test_service_discovery(self, service_name: str):
        ...
        try:
            ...
            for i, resource in enumerate(resources[:5]):  # Show first 5
                print(f"{i+1}. {resource.resource_type} - {resource.resource_name or resource.resource_id}")
