...
class HybridDiscoverySystem:
    ...
    def __init__(self, regions: List[str] = None):
        ...
        self.legacy_inventory.configure_discovery_mode(use_intelligent=False, standardized_output=False)
    ...
    def discover_resources_hybrid(self) -> List[Dict[str, Any]]:
        ...
        merged_resources = self._merge_and_enhance_resources(legacy_resources, intelligent_resources)
    ...
    def _merge_and_enhance_resources(
        ...
        intelligent_resources: List[Any]
    ) -> List[Dict[str, Any]]:
        """
        ...
        for legacy_resource in legacy_resources:
            ...
            if key in intelligent_dict:
                ...
                if not enhanced_resource.get('created_date') and intelligent_data.get('created_date'):
    ...
    def compare_with_legacy_only(self):
        ...
        print(f"  - Resources with tags - Legacy: {len(legacy_with_tags)}, Hybrid: {len(hybrid_with_tags)}")
